...
async function fetchProductDetails() {
    ...
    try {
        ...
        // APPLIED FORMAT PRICE HERE
        if(document.getElementById('decor-price')) document.getElementById('decor-price').textContent = formatPrice(data.price_range);
